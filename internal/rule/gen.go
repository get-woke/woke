...
var packageTemplate = template.Must(template.New("").Funcs(funcMap).Parse(`// Code generated by internal/rule/gen.go; DO NOT EDIT.
// Regenerate with 'go generate ./...'

package rule

{{ range .Rules }}
// {{ .Name | title }}Rule is the default rule for "{{ .Name }}"
var {{ .Name | title }}Rule = Rule{
	Name: "{{ .Name }}",
